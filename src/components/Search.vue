<template>
  <div :class="['weui-search-bar', { 'weui-search-bar_focusing': state.isFocus }]" id="searchBar">
    <form class="weui-search-bar__form">
      <div class="weui-search-bar__box">
        <i class="weui-icon-search"></i>
        <input v-model="state.searchValue" ref="inputElement" type="search" class="weui-search-bar__input"
...
const searchState = searchStatess()
...
watch(
  ...
  () => {
    ...
    // searchState.setSearchValue(state.searchValue);
  }
);
</script>